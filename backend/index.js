...
app.use('/api/crm-followups', require('./modules/crmLeads/followupsRoutes')); // Supabase followups (officer-owned)
...
app.use('/api/payment-setup', require('./modules/paymentSetup/batchPaymentSetupRoutes'));
